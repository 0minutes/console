...
class ConsoleApp:
    ...
    def create_widgets(self):
        ...
        self.output_text.config(state=tk.DISABLED, bg=DEFAULT_COLOR, font=DEFAULT_FONT, fg=FONT_COLOR)
        
        # Create an Entry widget for text input
        self.text = tk.Entry(self.console, bg=DEFAULT_COLOR, font=DEFAULT_FONT, fg=FONT_COLOR)
    ...
    def display_text(self, event):
        ...
        self.output_text.config(state=tk.NORMAL, fg=color)
